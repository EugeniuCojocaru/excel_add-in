...
## Project Context
You are building a React-based Excel Taskpane Add-in using **Tailwind CSS** and **Lucide React** (or Material Symbols) for icons. The design is a "Modern Minimalist" take on the Excel ecosystem, utilizing a clean card-based layout with a focus on high-density information display suitable for a narrow taskpane.
